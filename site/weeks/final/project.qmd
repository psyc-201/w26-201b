...
:::{.callout-caution icon=false title="📚 Final Project Template"}
[Github Classroom Assignment](https://classroom.github.com/a/-K-z07RZ)
:::

:::{.callout-tip title="Final Project Instructions Video" collapse=true}
{{< video https://www.dropbox.com/scl/fi/n4zuv0bcz9wykpdinh1hv/final-project-instructions.mp4?rlkey=sjugz6w1h9s08ty3pkmss80jx&st=z791cfnu&dl=1 height="400" >}}
:::
...
|  9   | Tues Mar 3 | Project proposal due |
...
For option 3 we've put together a large list of [open datasets](/datasets.qmd) that you can browse based on your research interests. By no means should you feel limited to using a dataset on this list! These are just to help you get started. 
