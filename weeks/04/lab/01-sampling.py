...
def _(penguins):
    ...
    return estimated_mean, estimated_std, n_obs
...
@app.cell
def _(estimated_mean, estimated_std, n_obs, normal):
...
@app.cell
def _(estimated_mean, estimated_std, n_obs, normal, pl):
...
@app.cell
def _(estimated_mean, estimated_std, n_obs, np, nsim, simulated_df, sns):
...
@app.cell
def _(estimated_mean, n_obs, penguins):
...
@app.cell
def _(bootstrap_df, estimated_mean, estimated_se, nboot, sns):
...
def _(n_obs, nboot, penguins, pl):
    ...
    return (bootstrap_df_corr,)


@app.cell
def _(bootstrap_df_corr, nboot, penguins, pl, sns):
